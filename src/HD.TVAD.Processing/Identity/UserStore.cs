...
namespace HD.TVAD.Processing.Identity
{
        ...
        where TUser : User
    {
        ...
        #region IUserStore
        IQueryable<TUser> UserTable => _userRepository.Datas as IQueryable<TUser>;
        ...
        public Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken)
        {
            ...
            return UserTable.FirstOrDefaultAsync(u => u.Id == id, cancellationToken);
        }
        ...
        public Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            return _userRepository.GetUserPermissionNamesAsync(user, cancellationToken);
        }
        //
        // Summary:
