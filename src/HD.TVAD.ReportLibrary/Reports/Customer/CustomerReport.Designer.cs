namespace HD.TVAD.ReportLibrary.Customer
{
	partial class CustomerReport
	{
		...
		private void InitializeComponent()
		{
			...
			this.cellSTT.Weight = 0.2087246596010523D;
			// 
			// xrTableCell3
			// 
			...
			this.xrTableCell3.Weight = 0.46613097282470933D;
			// 
			// xrTableCell4
			// 
			...
			this.xrTableCell4.Weight = 2.325144367574238D;
			// 
			// TopMargin
			// 
			...
			this.xrLabel1.SizeF = new System.Drawing.SizeF(692F, 23F);
            ...
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(691.9999F, 25F);
			...
			this.xrTableCell5.Text = "Index";
			this.xrTableCell5.Weight = 0.20872468529185789D;
			// 
			// xrTableCell1
			// 
			this.xrTableCell1.Name = "xrTableCell1";
			this.xrTableCell1.Text = "Code";
			this.xrTableCell1.Weight = 0.46613083313843662D;
			// 
			// xrTableCell2
			// 
			this.xrTableCell2.Name = "xrTableCell2";
			this.xrTableCell2.Text = "Name";
			this.xrTableCell2.Weight = 2.3251444815697058D;
			// 
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(HD.TVAD.ReportLibrary.Customer.CustomerViewModel);
			...
			this.Margins = new System.Drawing.Printing.Margins(68, 66, 48, 75);
