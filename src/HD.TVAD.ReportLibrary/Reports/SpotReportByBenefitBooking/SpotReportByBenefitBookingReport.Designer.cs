...
{
	partial class SpotReportByBenefitBookingReport
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.xrLabel1.Text = "TỔNG HỢP GIÁ TRỊ QUẢNG CÁO QUYỀN LỢI PHỤ -  [Parameters.IsApprovedText]";
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(HD.TVAD.ReportLibrary.SpotReportByBenefitBooking.SpotReportByBenefitBookingViewModel);
    ...
    "";
			...
			// 
			// SpotReportByBenefitBookingReport
			// 
