...
{
	partial class SpotReportByTrailerReport
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.xrTableCell6.Text = "POSITION COST";
			this.xrTableCell6.Weight = 0.37724333356140538D;
			// 
			// xrTableCell7
			// 
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.Text = "DISCOUNT VALUE";
			...
			this.xrLabel1.Text = "TRAILER SPOT REPORT [Parameters.IsApprovedText]";
