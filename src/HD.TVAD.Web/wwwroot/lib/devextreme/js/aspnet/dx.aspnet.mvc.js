    ...
    if ("function" === typeof define && define.amd) {
        define(function (require, exports, module) {
            module.exports = factory(require("jquery"),
                require("../dx.all"),
                require("devextreme-aspnet-data/js/dx.aspnet.data"),
                DevExpress.ui && DevExpress.ui.setTemplateEngine,
                DevExpress.ui && DevExpress.ui.templateRendered,
                DevExpress.data.Guid
			)
        })
    } else {
        var ui = DevExpress.ui;
        DevExpress.aspnet = factory(window.jQuery, null, null, ui && ui.setTemplateEngine, ui && ui.templateRendered, DevExpress.data.Guid)
    }
}(function($, devAll, devData, setTemplateEngine, templateRendered, Guid) {
