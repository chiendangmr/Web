...
namespace HD.TVAD.Web.Features.MAM.Evidence
{
    [Area("MAM")]
    [Authorize]
    public class EvidenceController : TVADController
    {
        ...
        public EvidenceController(IChannelService channelService, IAssetService assetService, IStorageService storageService, IEvidenceService evidenceService,
