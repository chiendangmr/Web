...
namespace HD.TVAD.Web.Features.Manage
{
    [Area("Tools")]
    [Authorize]
    public class AccessZoneController : TVADController
    {
        private AccessZoneBusiness _storageBussiness;
        public AccessZoneController(IHostingEnvironment hostingEnvironment,IAcessZoneService originService)
        {
            _storageBussiness = new AccessZoneBusiness(hostingEnvironment, originService);
        }
        #region View
        [HttpGet]
        ...
        [HttpPost]
        public async Task<IActionResult> Create(AcessZoneViewModel viewModel)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(AcessZoneViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Delete(AcessZoneViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
