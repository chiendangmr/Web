...
namespace OnAir.Data
{
    public partial class HDStationPS_V4Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=10.10.10.114;Database=HDStationPS_V4;User ID=sa;Password=Hd123456!DB;Persist Security Info=True;MultipleActiveResultSets=true;");
        }
