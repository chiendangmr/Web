...
<dl><dt><b>Description:</b></dt><dd>
License file. Path to license file, using to enable special features in some components.
</dd></dl>
<dl><dt><b>Type:</b></dt><dd>
VT_BSTR
</dd></dl>
...
\note Please keep in mind that you have to use EVR (=Enhanced Video Renderer) for DXVA 2.0 hardware acceleration under Windows Vista.
...
VT_UI4 </dd></dl>
<dl><dt><b>  Available Values: </b></dt><dd>
0 - Quality_ObeyQualityMessages - Respect quality messages from downstream filter and choose frame types to skip automatically to maintain synchronized playback.  <br>
1 - Quality_I - Skip P and B frames even if they are used as reference.  <br>
2 - Quality_IP - Skip B frames even if they are used as reference.  <br>
3 - Quality_IPB  - Do not skip frames.
...
VT_INT </dd></dl>
<dl><dt><b>  Available Values: </b></dt><dd>
0 - OSD feature is switched off.  <br>
1 - OSD feature is switched on.
...
VT_UI4 </dd></dl>
<dl><dt><b>  Available Values: </b></dt><dd>
0 - SMPMode_Off - Serial decoding. <br>
1 - SMPMode_Auto - Check for multi-threading and use "by picture" mode if it is available. <br>
2 - SMPMode_ByPictures - Parallel decoding by pictures. <br>
3 - SMPMode_BySlices - Parallel decoding by slices (it is actual for multi-slice pictures). <br>
