/** 
 @file  dec_mpa_mc.h
 @brief  Property GUIDs for MainConcept MPEG audio decoder parameters.
 
 @verbatim
 File: dec_mpa_mc.h

 Desc: Property GUIDs for MainConcept MPEG audio decoder parameters.
...
/**
* namespace el2ad
* @brief MPEG Audio Decoder namespace
**/
namespace el2ad{
...
/**
 * @name Input stream info (ISI)
 * @{
 **/

///@brief Input audio types
	enum	AUDIO_TYPE{
			AUDIOTYPE_Unknow		=	0,		///< Not connected
			AUDIOTYPE_DolbyAC3		=	1,		///< AC-3
			AUDIOTYPE_MPEG1			=	2,		///< MPEG-1
			AUDIOTYPE_MPEG2			=	3,		///< MPEG-2
			AUDIOTYPE_MPEG25		=	4,		///< MPEG-2,5
			AUDIOTYPE_LPCM			=	5,		///< LPCM
			AUDIOTYPE_PLII			=	6,		///< Pro Logic II
			AUDIOTYPE_AAC			=	7,		///< AAC
            AUDIOTYPE_AES3          =   8,		///< AES3
			AUDIOTYPE_HDMV_LPCM     =   9,		
			AUDIOTYPE_LPCM_LE       =  10		///< LPCM little endian
	};

///@brief Layers for MPEG and modes for AAC
	enum MODE{
		MODE_Unknow			=	0,			///< Unknown
		MODEMPEG_Layer1		=	1,			///< Layer I
		MODEMPEG_Layer2		=	2,			///< Layer II
		MODEMPEG_Layer3		=	3,			///< Layer III
		
		MODEAAC_Main		=	4,			///< Main
		MODEAAC_LC			=	5,			///< LC
		MODEAAC_SSR			=	6,			///< SSR	
		MODEAAC_LTP			=	7,			///< LTP
		MODEAAC_Scalable	=	8,			///< Scalable
		MODEAAC_TwinVQ		=	9,			///< TwinVQ
		MODEAAC_CELP		=	10,			///< CELP
		MODEAAC_HVXC		=	11,			///< HVXC
		MODEAAC_TTSI		=	12,			///< TTSI
		MODEAAC_Main_Synthetic						=	13,			///< Main synthetic
		MODEAAC_Wavetable_Synthesis					=	14,			///< Wavetable synthesis
		MODEAAC_General_MIDI						=	15,			///< General MIDI
		MODEAAC_Algorithmic_Syntesis_and_Audio_FX	=	16,			///< Algorithmic syntesis and audio FX
		
		MODEAAC_ER_LC			=	17,			///< ER LC
		MODEAAC_ER_LTP			=	17,			///< ER LTP
		MODEAAC_ER_Scalable		=	17,			///< ER Scalable
		MODEAAC_ER_TwinEQ		=	17,			///< ER TwinEQ
		MODEAAC_ER_BSAC			=	17,			///< ER BSAC
		MODEAAC_ER_LD			=	18,			///< ER LD
		MODEAAC_ER_HVXC			=	19,			///< ER HVXC
		MODEAAC_ER_CELP			=	18,			///< ER CELP
		MODEAAC_ER_HILN			=	19,			///< ER HILN
		MODEAAC_ER_Parametric	=	20			///< ER Parametric
	};

///@brief Channels mode for MPEG and AC-3
	enum	CHANNELS_MODE{
		CHANMODE_Unknow					=	0,		///< Unknown
		CHANMODEAC3_1_1_Dual			=	1,		///< 1+1 Dual
		CHANMODEAC3_1_1_Dual_LFE		=	2,		///< 1+1 Dual+LFE
		CHANMODEAC3_1_0_Center			=	3,		///< 1/0 - Mono
		CHANMODEAC3_1_0_Center_LFE		=	4,		///< 1/0+LFE - Mono
		CHANMODEAC3_2_0_Stereo			=	5,		///< 2/0 - Stereo
		CHANMODEAC3_2_0_Stereo_LFE		=	6,		///< 2/0+LFE - Stereo
		CHANMODEAC3_3_0_Front			=	7,		///< 3/0 - Front	
		CHANMODEAC3_3_0_Front_LFE		=	8,		///< 3/0+LFE - Front
		CHANMODEAC3_2_1_Surround		=	9,		///< 2/1 - Surround
		CHANMODEAC3_2_1_Surround_LFE	=	10,		///< 2/1+LFE - Surround
		CHANMODEAC3_3_1_Surround		=	11,		///< 3/1 - Surround
		CHANMODEAC3_3_1_Surround_LFE	=	12,		///< 3/1+LFE - Surround
		CHANMODEAC3_2_2_Quadro			=	13,		///< 2/2 - Quadro
		CHANMODEAC3_2_2_Quadro_LFE		=	14,		///< 2/2+LFE - Quadro
		CHANMODEAC3_3_2_5Channels		=	15,		///< 3/2 - 5 Channels
		CHANMODEAC3_3_2_5Channels_LFE	=	16,		///< 2/3+LFE - 5.1 Channels
		CHANMODEMPEG_SingleChannel		=	17,		///< Single channel
		CHANMODEMPEG_DualChannel		=	18,		///< Dual channel
		CHANMODEMPEG_JointStereo		=	19,		///< Joint stereo
		CHANMODEMPEG_Stereo				=	20,		///< Stereo
	};

/** @} */

/**
 * @name AC-3 decoder settings
 * @{
 **/
...
/**
 * @name Pro Logic II decoder settings
 * @{
 **/
...
/**
 * @name  MPEG,AAC,LPCM,AES3
 * @{
 **/
	enum	MAL_CHANNELS_CONFIG{
			MAL_CHANNELS_CONFIG_Auto	=	0,		///< Auto
			MAL_CHANNELS_CONFIG_Mono	=	1,		///< Mono
			MAL_CHANNELS_CONFIG_Stereo	=	2		///< Stereo
	};
 ...
 **/
	enum	MPEG_CHANNELS_CONFIG{
			MPEG_CHANNELS_CONFIG_First	=	0,		///< First
			MPEG_CHANNELS_CONFIG_Second	=	1,		///< Second
			MPEG_CHANNELS_CONFIG_Both	=	2		///< Both
	};
...
/**
 * @name Input stream info
 * @{
 **/

///@brief Retrieves input audio type (read-only).
...
///@brief Retrieves input channels configuration for AC-3, MPEG-1,-2, 2.5 streams (read-only)
...
///@brief Retrieves MPEG layers and AAC profiles (readonly)
...
///@brief Retrieves bit stream ID for AC-3 streams (read-only)
...
///@brief Retrieves quantization value for LPCM stream (read-only)
...
///@brief Retrieves the number of channels in the LPCM, Pro Logic II and AAC source streams (readonly)
...
///@brief Retrieves sample rate (readonly)
...
///@brief Retrieves bit rate (readonly)
...
/**
 * @name General decoder settings
 * @{
 **/

///@brief Sets the output bits per sample value
...
/**
 * @name  MPEG 1,2,2.5, AAC, LPCM, AES3 decoder settings
 * @{
 **/

///@brief Sets the configuration of the output channels for MPEG-1, 2, 2.5, and LPCM decoders
...
///@brief Configures MPEG channels for reproduction
...
// {70E333EE-5BC7-42cf-9EBB-C04F21994A04}
static const GUID EL2AD_MPEG_DelayRemoval = 
{ 0x70e333ee, 0x5bc7, 0x42cf, { 0x9e, 0xbb, 0xc0, 0x4f, 0x21, 0x99, 0x4a, 0x4 } };
