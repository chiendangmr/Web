...
// EMPGPDMX_PTSJUMPTHRESHOLD       VT_I8        0-_I64_MAX      25000000    This parameter allows specifying the maximum threshold value for the PTS discontinuity detection. The value is specified in 100 ns. units.      
