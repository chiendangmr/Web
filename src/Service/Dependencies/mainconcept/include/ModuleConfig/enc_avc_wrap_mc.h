/** 
 @file  enc_avc_wrap_mc.h
 @brief  Property GUIDs for MainConcept AVC/H.264 encoder wrapper parameters.
 
 @verbatim
 File: enc_avc_wrap_mc.h

 Desc: Property GUIDs for MainConcept AVC/H.264 encoder wrapper parameters.
...
#if !defined(__PROPID_H264ENC_WRAP_HEADER__)
#define __PROPID_H264ENC_WRAP_HEADER__
...
**/	
    typedef enum VideoType
    {
        ...
        VideoType_INTRA_CLASS_50_RP2027   = 33,
        VideoType_INTRA_CLASS_100_RP2027  = 34,
        VideoType_Ultraviolet_PD_L1       = 65,
        VideoType_Ultraviolet_PD_L2       = 66,
        VideoType_Ultraviolet_PD_L3       = 67,
        VideoType_Ultraviolet_SD_L1       = 68,
        VideoType_Ultraviolet_SD_L2       = 69,
        VideoType_Ultraviolet_HD_L1       = 70,
        VideoType_Ultraviolet_HD_L2       = 71,
        VideoType_INTRA_CLASS_200_RP2027  = 72,
        VideoType_XAVC_INTRA_CBG          = 73,
        VideoType_XAVC_INTRA_VBR          = 74,
        VideoType_AVCHD_20                = 75,
        VideoType_XAVC_LONG_GOP           = 77,
        VideoType_LONG_GOP_422_CLASS_G50  = 78,
        VideoType_LONG_GOP_422_CLASS_G25  = 79,
        VideoType_LONG_GOP_420_CLASS_G12  = 80,
        VideoType_LONG_GOP_420_CLASS_G6   = 81,
        VideoType_INTRA_CLASS_200         = 82
...
/**
* @brief Describes quantization mode.
**/	
...
/**
* @brief Describes parameter write sequence parameter set
**/	
    typedef enum WriteSPS
    {
        WriteSPS_IDR = 0,
        WriteSPS_I   = 1
...
/**
* @brief Describes parameter write picture parameter set
**/	
    typedef enum WritePPS
    {
        WritePPS_IDR = 0,
        WritePPS_I   = 1,
        WritePPS_PIC = 2
...
**/	
    ...
    typedef int (* startCallback)(h264_v_wrap_settings * enc_settings);
...
/**
* @brief Describes parameter write settings information
**/	
    typedef enum WriteSettingsInfo
    {
        WriteSetInfo_DontWrite,     // Don't write settings information
        WriteSetInfo_OnFirstIDR,    // Write settings information on first IDR only
        WriteSetInfo_OnEveryIDR     // Write settings information on every IDR
    };
};
...
//EH264VE_support_enc_mask						VT_INT      [0, limit of INT]                   READONLY				Support encoder mask
//EH264VE_user_enc_mask						VT_INT      [0, limit of INT]                   [0]				User encoder mask

//EH264VE_avc_encoder						VT_INT      [0, limit of INT]                   READONLY				Selected AVC Encoder
//EH264VE_used_avc_encoder					VT_INT      [0, limit of INT]                   READONLY				Used AVC Encoder
//EH264VE_HRD_preview						VT_INT      [0, 1]                   READWRITE				Enables/disables HRD preview mode
//EH264VE_Buffering						    VT_INT      [0, 20]                   READWRITE				Specifies maximum number of seconds to buffer
...
// {E32C5FA5-CD8E-4D3D-B75D-9AD45D743AA6}
static const GUID EH264VE_frame_packing_arrangement_mode = 
{ 0xe32c5fa5, 0xcd8e, 0x4d3d, { 0xb7, 0x5d, 0x9a, 0xd4, 0x5d, 0x74, 0x3a, 0xa6 } };
...
// {9E5028F4-7019-4262-98EB-6C0D4F716DB2}
static const GUID EH264VE_support_enc_mask = 
{ 0x9e5028f4, 0x7019, 0x4262, { 0x98, 0xeb, 0x6c, 0xd, 0x4f, 0x71, 0x6d, 0xb2 } };

// {7F355252-2512-4BEF-B4B2-0ADCBCB2E520}
//static const GUID EH264VE_user_enc_mask = 
//{ 0x7f355252, 0x2512, 0x4bef, { 0xb4, 0xb2, 0xa, 0xdc, 0xbc, 0xb2, 0xe5, 0x20 } };

// {540A976B-6EFB-401B-AE48-CF13E3A13431}
static const GUID EH264VE_avc_encoder = 
{ 0x540a976b, 0x6efb, 0x401b, { 0xae, 0x48, 0xcf, 0x13, 0xe3, 0xa1, 0x34, 0x31 } };

// {18776CFE-F2B0-4947-BF6D-0CE72B24474D}
static const GUID EH264VE_used_avc_encoder = 
{ 0x18776cfe, 0xf2b0, 0x4947, { 0xbf, 0x6d, 0xc, 0xe7, 0x2b, 0x24, 0x47, 0x4d } };

// {51A2285A-8518-4DAC-9735-90F8BA2F6A54}
static const GUID EH264VE_DeviceNum = 
{ 0x51a2285a, 0x8518, 0x4dac, { 0x97, 0x35, 0x90, 0xf8, 0xba, 0x2f, 0x6a, 0x54 } };

// {CF74B213-0677-4B86-BBF0-AE573EBB0E63}
static const GUID EH264VE_HRD_preview = 
{ 0xcf74b213, 0x677, 0x4b86, { 0xbb, 0xf0, 0xae, 0x57, 0x3e, 0xbb, 0xe, 0x63 } };

// {84D30249-CA4F-48C0-9513-7457AFCDFEC3}
static const GUID EH264VE_Buffering = 
{ 0x84d30249, 0xca4f, 0x48c0, { 0x95, 0x13, 0x74, 0x57, 0xaf, 0xcd, 0xfe, 0xc3 } };

// {70D92C1D-AE31-44AE-BAAC-ACBF03CE608F}
static const GUID EH264VE_Encoding_Buffering = 
{ 0x70d92c1d, 0xae31, 0x44ae, { 0xba, 0xac, 0xac, 0xbf, 0x3, 0xce, 0x60, 0x8f } };

// {B6177E58-5787-4C7C-AFA3-23A34F4C3EC0}
static const GUID EH264VE_Product_info_in_SEI = 
{ 0xb6177e58, 0x5787, 0x4c7c, { 0xaf, 0xa3, 0x23, 0xa3, 0x4f, 0x4c, 0x3e, 0xc0 } };

// {10A2C50E-E37C-4EAC-9A43-24D71DAED759}
static const GUID EH264VE_WriteSPS = 
{ 0x10a2c50e, 0xe37c, 0x4eac, { 0x9a, 0x43, 0x24, 0xd7, 0x1d, 0xae, 0xd7, 0x59 } };

// {BE1D9751-2F86-4669-A9D8-20F524BED2CF}
static const GUID EH264VE_WritePPS = 
{ 0xbe1d9751, 0x2f86, 0x4669, { 0xa9, 0xd8, 0x20, 0xf5, 0x24, 0xbe, 0xd2, 0xcf } };

// {E8F35536-5A47-4EE8-A8A4-C8BE6A95044D}
static const GUID EH264VE_WriteSettingsInfo = 
{ 0xe8f35536, 0x5a47, 0x4ee8, { 0xa8, 0xa4, 0xc8, 0xbe, 0x6a, 0x95, 0x4, 0x4d } };


#endif // __PROPID_H264ENC_WRAP_HEADER__
