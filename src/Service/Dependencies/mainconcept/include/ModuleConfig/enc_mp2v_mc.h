 /** 
 @file  enc_mp2v_mc.h
 @brief  Property GUIDs for MainConcept MPEG-2 video encoder parameters.
 
 @verbatim
 File: enc_mp2v_mc.h

 Desc: Property GUIDs for MainConcept MPEG-2 video encoder parameters.
...
//
//	MC_PRESET					VT_INT			MPEG1				MPEG_MPEG2		MPEG-1
//												VCD,								MPEG-1 VideoCD
...
//	MC_PROFILE					VT_INT			HIGH_PROFILE		PROFILE_MAIN	High profile
//												MAIN_PROFILE						Main profile
//												SIMPLE_PROFILE						Simple profile
//												PROFILE_4_2_2							442 profile
//	MC_LEVEL					VT_INT			HIGH_LEVEL			LEVEL_MAIN			High level
//												HIGH1440_LEVEL						High1440 level
//												MAIN_LEVEL							Main level
//												LOW_LEVEL							Low level
//												UNSPECIFIED_LEVEL					Unspecified level. No level's restrictions presents.  
//	MC_GOP_LENGTH				VT_INT			[1-100], multiply of M		12		Number of frames in GOP
//	MC_GOP_BCOUNT				VT_INT			[0-7]				3				Number of B-frames between I/P frames
...
//	MC_ASPECT_RATIO			VT_INT												The display aspect ratio code and is different depending on the MPEG type. (see AspectRatio enum)
...
//	MC_BITRATE_AVG				VT_INT			Level limitation					Average bitrate in bits
//	MC_BITRATE_MAX				VT_INT			Level limitation					Maximum bitrate in bits (available for VBR RC mode, should be larger then average bitrate) 
//	MC_BITRATE_MIN				VT_INT			Level limitation					Minimum bitrate in bits (available for VBR RC mode, should be smaler then average bitrate) 
//	MC_BITRATE_MODE			VT_INT			0,1					0				Indicate whether the encoder should encode in constant or variable bitrate mode. 1 - constant bitrate, 0 - variable bitrate.
...
//	MC_OUT_SAMPLE_SIZE			VT_INT			[0..-]				0				Specifies size of output samples. 0 - size of output sample will be calculeted automatically from picture size.
//	MC_OEM_NAME				VT_BSTR			READ-ONLY							Indicate OEM custommer's name
//	MC_OPERATION_MODE			VT_INT			MC_COMMON::OperationMode			Indicate evaluation state of product
//	MC_ENCODED_FRAMES			VT_INT			READ-ONLY							indicate amount of encoded frames
...
//	MC_BITRATE_PASS			VT_INT			EM2VE::TwoPassMode_t TWO_PASS_MODE_OFF Specifies using two-pass encoding mode.
//	MC_BITRATE_STAT			VT_BSTR			-									File path for storage rate control statistics
...
// {D4879D9A-62DB-4690-94D1-E65510C01E0D}
static const GUID EM2VE_ChapterList = 
{ 0xd4879d9a, 0x62db, 0x4690, { 0x94, 0xd1, 0xe6, 0x55, 0x10, 0xc0, 0x1e, 0xd } };

// {F700DE36-53EB-40AA-AB8B-BD13A03660BD}
static const GUID EM2VE_PixRangeFlag = 
{ 0xf700de36, 0x53eb, 0x40aa, { 0xab, 0x8b, 0xbd, 0x13, 0xa0, 0x36, 0x60, 0xbd } };

    // {C40B8BCD-8188-47F5-8231-33E25D677E35}
static const GUID EM2VE_write_settings_info = 
{ 0xc40b8bcd, 0x8188, 0x47f5, { 0x82, 0x31, 0x33, 0xe2, 0x5d, 0x67, 0x7e, 0x35 } };


/**
* namespace EM2VE
* @brief EMPEG-2 specific namespace
**/
namespace EM2VE
{
#define EMVE_MAX_CHAPTER_LIST 1023
...
**/
	enum VideoType
	{
		...
		BD          = 26,
		BD_HDMV     = 27,
		XDCAM_1080_CBR_25   = 32,
		XDCAM_1080_VBR_17_5 = 33,
		XDCAM_1080_VBR_35   = 34,
		XDCAM_540_CBR_12_5  = 35,
		XDCAM_540_VBR_8_75  = 36,
		XDCAM_540_VBR_17_5  = 37,

        XDCAM_HD_420_1280   = 38,    // XDCAM HD MP@HL   4:2:0 1280x720   (35 Mbit VBR)
        XDCAM_HD_422_1920   = 39,    // XDCAM HD 422P@HL 4:2:2 1920x1080  (50 Mbit CBR)
        XDCAM_HD_422_1280   = 40,    // XDCAM HD 422P@HL 4:2:2 1280x720   (50 Mbit CBR)
        XDCAM_EX_1920       = 41,    // XDCAM EX MP@HL   4:2:0 1920x1080  (35 Mbit VBR)
        XDCAM_EX_1440       = 42,    // XDCAM EX MP@H-14 4:2:0 1440x1080  (25 Mbit CBR)
        XDCAM_EX_1280       = 43    // XDCAM EX MP@HL   4:2:0 1280x720   (35 Mbit VBR)
	};
/**
...
**/
	...
	{
		EM2VE_HIGH_LEVEL = 4,
		EM2VE_HIGH1440_LEVEL = 6,
		EM2VE_MAIN_LEVEL = 8,
		EM2VE_LOW_LEVEL = 10,
		EM2VE_UNSPECIFIED_LEVEL = 15
	};
