...
#define M4D_DISABLE_SATURATION              0x00000000
#define M4D_ENABLE_SATURATION               0x00000001
#define DEFAULT_SATURATION      M4D_ENABLE_SATURATION
...
typedef struct m4d_decoder_settings
{
    ...
    int32_t   DC_saturation;        /**< \brief Enable/Disable saturation for inverse quantized DC coefficient (accordance to 7.4.4.4 section in ISO/IEC 14496-2) */
    int32_t   reserved_5[99];		/**< \brief Reserved */
