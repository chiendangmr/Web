 ...
 */
  ...
  int32_t  topfirst;                              /**<@brief Display field order (1 == top field first) */
  ...
  int32_t  encoding_delay;                        /**<@brief Frames in input queue for preprocessing. 0 - Auto. 1 - disable. Other values - number of frames.*/
  int32_t  reserved11[7];                         /**< */
/**@}*/
/**
...
/**
 * @name Field order defines for source video
 * @brief Define field-dominance for whole video-sequence {0,0}-undefined, {1,0} top-first, {0,1}-bottom first, {1,1}-progressive
 * @{
 */
...
/**
* @name Additional encoding options
* @{
*/
#define INIT_OPT_EXTERN_FRM_BUF 0x00000001          /**<@brief Use external frame buffer @hideinitializer*/
#define INIT_OPT_NR_FILT        0x00000002          /**<@brief Use preprocessing filter  @hideinitializer*/
#define INIT_OPT_AUTHENT        0x00000010
/**@}*/

/**
* @name 2-pass encoding options
* @{
*/
#define INIT_OPT_VBR_TWO_PASSES  0x00000800        /**<@brief Use for internal metadata 2-pass encoding   @hideinitializer*/
#define INIT_OPT_VBR_ANALYSE     0x00000900        /**<@brief Init for analyze pass   @hideinitializer*/
#define INIT_OPT_VBR_ENCODING    0x00000F00        /**<@brief Init for encoding pass   @hideinitializer*/
...
/**@}*/
#define INIT_OPT_CHAPTER_LIST    0x00001000     /**<@brief   Use to set chapter marks @hideinitializer*/
/**
...
#define VCSD_FLAGS_KICKUP  0x00000004            /**<@brief There is no much motion in next frames @hideinitializer*/
#define VCSD_FLAGS_STILL   0x00000008            /**<@brief There is no much motion in next frames @hideinitializer*/
