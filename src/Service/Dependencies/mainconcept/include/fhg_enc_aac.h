...
typedef struct fhg_aac_a_encoder_info_s
{
    int32_t nSyncFrameDelay;
    int32_t reserved_int32[64];     
    void *reserved_ptr[32];
} fhg_aac_a_encoder_info;
#pragma pack(pop)
...
/** @brief Call this function to make the next encoded AAC frame a sync frame.
 *
 * The function can be called in any time between @ref fhgAacOutAudioInit() and @ref fhgAacOutAudioDone() functions.
 *
 * @param[in] instance a pointer to a @ref fhg_aac_aenc_tt object
 ...
 * @return @ref aacOutError if not
 */
int32_t MC_EXPORT_API fhgAacOutSetSyncFrame(fhg_aac_aenc_tt *instance);


/** @brief Call this function to get additional encoder information.
 *
 * The function can be called in any time between @ref fhgAacOutAudioInit() and @ref fhgAacOutAudioDone() functions.
 ...
 * @return @ref aacOutError if not
 */
int32_t MC_EXPORT_API fhgAacOutAudioGetEncoderInfo(const fhg_aac_aenc_tt *instance, fhg_aac_a_encoder_info *information);
