	...
	namespace NetworkStreaming {
        ...
        **/
		...
		public:
            ...
            **/
			virtual int32_t Parse( const char *pData, int32_t iDataLen, bool bIsPartOfMultiPartStream = false ) = 0;
            ...
            **/
			virtual const char * GetRequestedURI() const = 0;
            ...
            **/
			virtual const char * GetRequestedPath() const = 0;
            ...
            **/
			virtual const char * GetRequestedQueryString() const = 0;
            ...
            **/
			virtual const char * GetErrCodeString() const = 0;
            ...
            **/
			virtual const char * GetCallback() const = 0;
            ...
            **/
			virtual const char * GetNT() const = 0;
            ...
            **/
			virtual const char * GetMultiPartBoundary() const = 0;
		...
		extern "C" {
            ...
            * @return		None
            **/
			void NET_API_CALL HttpMakeRelativePath( const char *pEncodedString, char *pOutDecodedString );
            ...
            * @return		None
            **/
			void NET_API_CALL HttpRemoveNonPathSymbols( const char *pEncodedString, char *pOutDecodedString );
            ...
            * @return		None
            **/
			void NET_API_CALL HttpUrlDecode( const char *pEncodedString, char *pOutDecodedString );
            ...
            **/
			int32_t NET_API_CALL HttpCalculateHeadersLen( const char *pData, int32_t iDataLen, bool bIsMultiPart = false );
            ...
            **/
			HttpMethod NET_API_CALL HttpFetchMethod( const char *pData, int32_t iDataLen );
            ...
            **/
			const char * NET_API_CALL HttpFetchURI( const char *pData, int32_t iDataLen, int32_t *pUriLen );
            ...
            **/
			bool NET_API_CALL HttpCheckHeaders( const char *pData, int32_t iDataLen );
