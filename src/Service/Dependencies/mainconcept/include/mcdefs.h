...
#define MPEG_CABLELABS             24      /**<@brief CableLabs MPEG-2 MP @ ML (3.18MBit) or MP @ HL (18.1MBit) @hideinitializer */
...
#define MPEG_CABLELABS_HD1         48      /**<@brief CableLabs MPEG-2 MP \@ HL 1280x720 (15MBit) @hideinitializer */
#define MPEG_CABLELABS_HD2         49      /**<@brief CableLabs MPEG-2 MP \@ HL 1920x1080 (15MBit) @hideinitializer */
...
#define MPEG_LAST_MPEG_TYPE        52      /**<@brief last MPEG type @hideinitializer */
/**@}*/
/**@}*/
...
//---------------------------------- get_rc typedef -----------------------------------------
// declared for convinience
/**
@brief Get resource function typedef

Used to provide pointers to message handling and memory management functions for components.
For more information see the @ref GET_RC_PAGE "dedicated page".
