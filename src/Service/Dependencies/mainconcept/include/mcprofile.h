...
/**
*@ingroup MPEG2_PRESETS_AND_PROFILES H264_VIDEO_TYPES
*@{
*/
...
#define MCPROFILE_DPS_V_TPT                     0x00008640       /**< @brief DivX Plus Streaming Trick-play Track for AVC and HEVC @hideinitializer */
...
#define MCPROFILE_DASH_L1                       0x00013001       /**< @brief DASH 768x432, 400kb     @hideinitializer */
#define MCPROFILE_DASH_L2                       0x00013002       /**< @brief DASH 768x432, 600kb     @hideinitializer */
#define MCPROFILE_DASH_L3                       0x00013003       /**< @brief DASH 768x432, 800kb     @hideinitializer */
#define MCPROFILE_DASH_L4                       0x00013004       /**< @brief DASH 768x432, 1200kb    @hideinitializer */
#define MCPROFILE_DASH_L5                       0x00013005       /**< @brief DASH 1280x720, 1750kb   @hideinitializer */
#define MCPROFILE_DASH_L6                       0x00013006       /**< @brief DASH 1280x720, 2400kb   @hideinitializer */
#define MCPROFILE_DASH_L7                       0x00013007       /**< @brief DASH 1920x1080, 3500kb  @hideinitializer */
#define MCPROFILE_DASH_L8                       0x00013008       /**< @brief DASH 1920x1080, 5300kb  @hideinitializer */
#define MCPROFILE_DASH_L9                       0x00013009       /**< @brief DASH 1920x1080, 8400kb  @hideinitializer */
#define MCPROFILE_DASH_L10                      0x00013010       /**< @brief DASH 3840x2160, 15 Mbit @hideinitializer */
#define MCPROFILE_DASH_L11                      0x00013011       /**< @brief DASH 3840x2160, 20 Mbit @hideinitializer */
#define MCPROFILE_DASH_L12                      0x00013012       /**< @brief DASH 3840x2160, 25 Mbit @hideinitializer */
/**@}*/
