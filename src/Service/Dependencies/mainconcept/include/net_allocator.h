    ...
    namespace NetworkStreaming {
        ...
        **/
        ...
        public:
            ...
            */
            virtual uint8_t *GetBuffer( uint32_t *puiBufferSize, uint32_t uiRequestedSize ) = 0;
            ...
            */
            virtual MCNETRESULT Confirm( uint8_t *pBuffer, uint32_t uiUsedBytes ) = 0;
            ...
            * @return            Return MCNETRESULT
            */
            virtual MCNETRESULT ReleaseBuffer( uint8_t *pBuffer ) = 0;
