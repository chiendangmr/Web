    ...
    namespace NetworkStreaming {
        ...
        */
        ...
        public:
			...
			**/
            ...
            /**
            * @brief Segment index when applicable, LLONG_MAX otherwise
            *
            * @return Segment index.
            **/
            virtual const uint64_t GetSegmentIndex() const = 0;
        };
        ...
        */
        ...
        public:
			...
			**/
			virtual const IMCResourceLocation* GetLocation(size_t index) const = 0;
			...
			**/
            virtual const IMCResourceLocation* GetInitLocation(size_t index) const = 0;
        ...
        */
        ...
        public:
			...
			* @brief Get segment by its start time relative to presentation begin.
              ...
              @param[in] ui64CurrentDownloadRate current download rate in bits, enable skipping segments if present, has more priority over ui64PrevIndex
              @param[in] ui64PrevIndex the segment base index value from the previous request (when applicable), ULLONG_MAX otherwise or at the first request, used for sequential access even for obsolete segments
              @param[in] bSeek the flag that seeking operation has been requested, this flag should be set to true whenever contributor of the API wants to make a navigation inside the stream, both live and VOD
			* 
			...
			**/
            virtual IMCPlaylistSegmentItem* GetByTime(uint64_t uiSegmentStartTime, uint64_t uiTimescale, uint64_t ui64CurrentDownloadRate, uint64_t ui64PrevIndex, bool bSeek) = 0;
            ...
            * @param[in] ui64PrevIndex index for the segment from the previous request (when applicable), ULLONG_MAX otherwise or at the first request
        ...
        class IMCContentProtection : public IMCAttributeEnumerator {

        public:
            virtual ~IMCContentProtection() {};
		...
		public:
			...
			**/
			virtual const char *GetQualityURI( uint64_t uiSegmentPosition = 0 ) = 0;
			...
			**/
			virtual const uint64_t GetPresentationTimeOffset( uint64_t *pScale ) = 0;

			/**
			* @brief Get count of the protection information entries within playlist
			* @return	Count of the protection information entries within playlist
			**/
            virtual const size_t GetProtectionInfoCount() = 0;

			/**
			* @brief Get content protection entry by specified index from the playlist
			* @param[in] i		index of content protection entry, in the range between zero and value returned by GetProtectionInfoCount() call (non-inclusive)
			* @return	Valid pointer to IMCContentProtection or NULL if index is out of range
			**/
           virtual const MainConcept::NetworkStreaming::IMCContentProtection* GetProtectionInfo( size_t i ) = 0;
		};
        ...
        public:
			...
			**/
            virtual const char * GetKeyURI() = 0;
		...
		public:
			...
			**/
			virtual const char *GetContentBase() = 0;
        ...
        */
		...
		public:
			...
			**/
			virtual IMCPlaylist *CreatePlaylist( const char *pURI ) = 0;
			...
			**/
			virtual int32_t ParseChunk( const char *pBuffer, int32_t iLen, bool bEof, IMCPlaylist *pPlaylist ) = 0;
        ...
        */
        ...
        public:
            ...
            */
            virtual uint64_t Read( uint8_t* pBuffer, uint64_t uiOffset, uint64_t size) = 0;
        };
        ...
        */
        ...
        public:
            ...
            */
            virtual IMCReader* Create(const char* pUri) = 0;
