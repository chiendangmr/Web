    ...
    namespace NetworkStreaming {                          
        ...
        **/                                                          
        ...
        typedef struct _tagRtcpExternalSdpInfo {
            ...
            char* ucsRtcpSrcAddress;                             /**< RTCP source address */
        ...
        typedef struct _tagLiveStreamingParams {
            ...
            char*           ucsNIC;                                 /**< local network interface */
            uint32_t        ulServerPort;                           /**< server port @deprecated not being use anymore*/
            char*           csServerName;                           /**< server address */
        ...
        **/
        typedef struct _tagMCNetSourceRtpInfo {
            ...
            char* pUri;                                             /**< Absolut control URI for media stream */
        } MCNETSOURCERTPINFO;
        ...
        **/
        ...
        public:
            ...
            * @return         true on success else false
            **/
            virtual bool SetNic( const char *pNIC ) = 0;
            ...
            * @return                   true on success else false
            **/
            virtual bool SetSapSettings( const char **plstSapAddress, uint32_t uiAddressCount, uint32_t uiSapPort ) = 0;
        ...
        **/
        ...
        public:
            ...
            * @return          Returns @ref MCNetResultOK on success and error code otherwise
            **/
            virtual MCNETRESULT SetUserAgent( const char *aBuff ) = 0;
            ...
            * @return              Returns @ref MCNetResultOK on success and error code otherwise
            **/
            virtual MCNETRESULT SetProxyURL( const char *pProxyURL ) = 0;
            ...
            **/
            virtual const char * GetMimeTypeStringValue() const = 0;
            ...
            **/
            ...
            /**
            * @brief Sets received buffer size (can be increased during receiving automatically by the http engine itself)
            *
            * @param[int] buffer_size_bytes    receiving buffer size in bytes
            **/
            virtual void SetBufferSize(size_t buffer_size_bytes) = 0;
        };
        ...
        **/
        ...
        public:
            ...
            * @return None
            **/
            virtual void OnRedirect(const char* pUrl, int32_t iUrlLen, const char* pRange = NULL) = 0;
        };
        ...
        **/
        ...
        public:
            ...
            **/
            virtual MCNETRESULT Init( const char *aServerName, uint32_t aPort, const char *aUrl, const char *aNIC = NULL ) = 0;
            ...
            * @return               Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT Play( const char *aStartTime = NULL, const char *aEndTime = NULL, const char *aRate = NULL ) = 0;
            ...
            * @return                     Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT Options( const char *pUserData = NULL, uint32_t uiUserDataLength = 0 )  = 0;
            ...
            * @return         Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT Describe( const char *aURI ) = 0;
            ...
            * @return               Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT Announce( const char *aURI, const char *aSDPpacket ) = 0;
            ...
            * @return                   Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT SetParameter( const char *pParam, int32_t iParamLen, const char *pParamValue, int32_t iParamValueLen, const char *pContentType = NULL ) = 0;
            ...
            * @return                    Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT GetParameter( const char *pParam, int32_t iParamLen, const char **pParamValue, int32_t* iParamValueLen ) = 0;
            ...
            * @return                             Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT SetMediaDataConsumer( IMediaConsumer *pMediaConsumer, uint32_t nMediaID, const char *csServerMulticastAddress = NULL, bool bRtcpShouldPresent = false ) = 0;
            ...
            * @return                             Return @ref MCNETRESULT
            **/
            virtual MCNETRESULT SetMediaDataConsumer( IMediaConsumer *pMediaConsumer, const ISdpMediaInfo *pMediaInfo, const char *csServerMulticastAddress = NULL, bool bRtcpShouldPresent = false ) = 0;
            ...
            **/
            virtual const uint8_t * GetSpecificServerConfig( int32_t *pDatalen ) const = 0;
            ...
            * @return          None
            **/
            virtual void SetSpecificSourceAddress( const char *aBuff ) = 0;
