...
/** 
<dl><dt>easy bilinear only</dt></dl>
*/
#define SCALER_MODE_BILINEAR      0x00000002
/** 
<dl><dt>FIR-8 polyphase filter</dt></dl>
*/
#define SCALER_MODE_POLYPHASE8    0x00000003

/** 
<dl><dt>currently FIR-8 polyphase filter</dt></dl>
...
/** 
<dl><dt>scale fields independent</dt></dl>
*/
#define SCALER_MODE_INTERLACED    0x00000100

/** 
<dl><dt>how to handle ends in src_rect parameter</dt></dl>
*/
...
/** 
<dl><dt>how the input-output  YUV-colorspace is defined</dt></dl>
*/
...
/**
<dl><dt>internal blend source over destination</dt></dl>
*/
#define SCALER_OPT_BLEND_OVER     0x00000100 //internal blend source over destination

/**
<dl><dt>internal blend destination over source</dt></dl>
*/
#define SCALER_OPT_BLEND_UNDER    0x00000300 //internal blend destination over source

/**
<dl><dt>external blending</dt></dl>
*/
#define SCALER_OPT_BLEND          0x0000FF00 //external blending

/** 
<dl><dt>must be set to use the rect-structure for decription of region</dt></dl>
*/
#define SCALER_OPT_EXT_PRECISION  0x00000001
/** 
  <dl><dt>Five bits in opt_Flags parameter (from the 2nd to the 6th) is used to set the number of threads.
  If the bits is set 0 then number of threads is equal to the core count. The number of threads can't be more than 16.</dl></dt>
*/
...
#endif
/**
   @brief General API function
   @param[in] optFlags
   @param[in] SrcLayout
   @param[in] SrcPtr
   @param[in] SrcRealLineSize
   @param[in] SrcWidth
   @param[in] SrcHeight
   @param[in] DstLayout
   @param[out] DstPtr     
   @param[in] DstRealLineSize
   @param[in] DstWidth
   @param[in] DstHeight
   @param[in] ColorTable
   @param[in] mode_flags
...
/**
   @brief returns appropriate API function pointer.
   @param[in] func
*/
