...
typedef enum ucc_color_primaries_e {
    ...
    UCC_COLOR_PRIMARIES_BT2020                  = 5,    //R(0.708 0.292) G(0.170 0.797) B(0.131 0.046) W(0.3127 0.3290)
														//BT.2020
    UCC_COLOR_PRIMARIES_SMPTE_RP_431_2          = 6,    //R(0.680 0.320) G(0.265 0.690) B(0.150 0.060) W(0.314 0.351)
                                                        //Society of Motion Picture and Television Engineers RP 431 - 2 (2011)
    UCC_COLOR_PRIMARIES_SMPTE_EG_432_1          = 7,    //R(0.680 0.320) G(0.265 0.690) B(0.150 0.060) W(0.3127 0.3290)
                                                        //Society of Motion Picture and Television Engineers EG 432 - 1 (2010)
    UCC_COLOR_PRIMARIES_EBU_Tech_3213_E         = 8     //R(0.630 0.340) G(0.295 0.605) B(0.155 0.077) W(0.3127 0.3290)
...
typedef enum ucc_transfer_characteristics_e {
    ...
    UCC_TRANSFER_CHARACTERISTICS_SMPTE_ST_2084      = 7,    //Society of Motion Picture and Television Engineers ST 2084 for 10, 12, 14, and 16 - bit systems
                                                            //Rec.ITU - R BT.2100 perceptual quantization(PQ) system
    UCC_TRANSFER_CHARACTERISTICS_SMPTE_ST_428_1     = 8,    //Society of Motion Picture and Television Engineers ST 428 - 1
    UCC_TRANSFER_CHARACTERISTICS_BT2100_HLG         = 9     //ITU - R BT.2100, Hybrid Log-Gamma (HLG) system reference non-linear transfer functions
...
/// Overlay type
typedef enum ucc_overlay_e {
    UCC_OVERLAY_LOGO        = 0,
    UCC_OVERLAY_OSD         = 1
} ucc_overlay_t;

/// Overlay configuration
typedef struct ucc_overlay_config_s {
    struct ucc_overlay_config_s *next;  ///< Next overlay configuration
    ucc_overlay_t               type;   ///< Overlay type
    uint8_t                    *luma;  ///< Luma plane
    int32_t                     x;      ///< Overlay x-position
    int32_t                     y;      ///< Overlay y-position
    uint32_t                    width;  ///< Overlay width
    uint32_t                    height; ///< Overlay height
} ucc_overlay_config_t;
...
/*
	Rotation mode. Not supported currently.
*/
...
/** @brief Defines for pixel format.
  ...
  * </table>
  <br/>
  * More detail information about FOURCC is here: @ref COLORSPACE_PAGE
  <br/>
  */
typedef enum ucc_pixel_format_e {
	...
	UCC_PIXEL_FORMAT_v216 = 78,					//4:2:2 16 bit little-endian UYVY
    UCC_PIXEL_FORMAT_400_GRAY = 79,             //4:0:0 8-bit Gray
    UCC_PIXEL_FORMAT_400_Y16 = 80,              //4:0:0 16-bit Gray
    UCC_PIXEL_FORMAT_400_Y10 = 81,              //4:0:0 10-bit Gray
	UCC_PIXEL_FORMAT_PL_444_Y13V13U13_48 = 82,  //W413
    UCC_PIXEL_FORMAT_PL_422_Y13V13U13_32 = 83,  //W213
    UCC_PIXEL_FORMAT_PL_420_Y13V13U13_24 = 84,  //W013
    UCC_PIXEL_FORMAT_PL_X13Y13Z13_48 = 85,
    UCC_PIXEL_FORMAT_PL_444_R13G13B13_48 = 86,
    UCC_PIXEL_FORMAT_PL_444_Y15V15U15_48 = 87,  //W415
    UCC_PIXEL_FORMAT_PL_422_Y15V15U15_32 = 88,  //W215
    UCC_PIXEL_FORMAT_PL_420_Y15V15U15_24 = 89,  //W015
    UCC_PIXEL_FORMAT_PL_X15Y15Z15_48 = 90,
    UCC_PIXEL_FORMAT_PL_444_R15G15B15_48 = 91,
    UCC_PIXEL_FORMAT_400_Y09 = 92,              //4:0:0 9-bit Gray
    UCC_PIXEL_FORMAT_400_Y11 = 93,              //4:0:0 11-bit Gray
    UCC_PIXEL_FORMAT_400_Y12 = 94,              //4:0:0 12-bit Gray
    UCC_PIXEL_FORMAT_400_Y13 = 95,              //4:0:0 13-bit Gray
    UCC_PIXEL_FORMAT_400_Y14 = 96,              //4:0:0 14-bit Gray
    UCC_PIXEL_FORMAT_400_Y15 = 97,              //4:0:0 15-bit Gray
    UCC_PIXEL_FORMAT_010P = 98,
    UCC_PIXEL_FORMAT_210P = 99,
...
typedef struct ucc_frame_s {
	...
	* This feature is disabled in current version.
	* @{
	**/
...
typedef struct ucc_config_s {
	union {
		struct {
            ...
            uint32_t	disable_avx2_flag               :1; ///< Indicates that commands from AVX2 instructions set must not be used.
		};
	...
	ucc_speed_quality_switch_t	speed_quality_switch;			///< Speed/quality switch. One of @ref ucc_speed_quality_switch_t. It is deprecated.

	int32_t flip;												///< Vertical flip mode for the output picture

	int32_t	threads_count;										///< Number of threads.

	int32_t						sharpness_coef;					///< Sharpness change coefficient. The range is -100 .. 100. The value 0 means no changes will be made.
    ...
    /**
	  ...
	  * @{
      Note:
      In case of v210 output color space there are several restrictions while using black stripes feature. Following specification:
        - width of left stripe should be multiple of 48;
        - difference between frame's width and right black stripe's width should be multiple of 48.<br/>
      Current conditions are important to save the sequence of components in V210 format.
      For most other color spaces these conditions should be a multiple of number of pixels per macropixel.
	**/
	...
	**/
    ...
    void *  thread_pool;
    ucc_overlay_config_t *overlay;                       ///< Overlay configuration. Experimental feature.
	void*	reserved_ptr[62];
	/** @} */
}ucc_config_t;
...
extern "C" {
    ...
    /** @brief Call this function to help to initialize a frame description structure.
	 *
	 * @param[in] pbuf pointer to the frame buffer
     * @param[in] cs_info pointer to @ref frame_colorspace_info_tt structure     
	 * @param[out] dst pointer to @ref ucc_frame_t structure
	 * @return error code from @ref ucc_error_t enumeration
	 */
    ucc_error_t     MC_EXPORT_API UCC_InitFrameBuffer(ucc_frame_t *dst, uint8_t *pbuf, frame_colorspace_info_tt *cs_info);

    /** @brief Call this function to get FourCC format from UCC pixel format.
	 *
	 * @param[in] pixel_format pixel format from @ref ucc_pixel_format_t enumeration
     * @param[in] short_range_flag short range flag
	 * @return FourCC format value\n
     *         0 if pixel format is unsupported
	 */
    int32_t         MC_EXPORT_API UCC_GetFourCCFromUCCFormat(ucc_pixel_format_t pixel_format, int32_t short_range_flag);
