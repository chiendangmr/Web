        ...
        namespace UpnpStack {
            ...
            **/
			...
			public:
                ...
                **/
				virtual const char * GetOutMimeType( void ) = 0;
                ...
                **/
                virtual const char * GetOutProfile(void) = 0;
			};
            ...
            **/
			...
			public:
                ...
                * 
				* @param[in] pInputFileName complete path to source media file in UTF8
                ...
                * @return Return @ref MCNETRESULT
                **/
				virtual MCNETRESULT RequestJob( const IUpnpContentDirectoryItem *pItem, uint32_t uiTargetID, ITranscoderObserver *pObserver, ITranscoderJob **ppJob ) = 0;
			};
		};
	};
};
